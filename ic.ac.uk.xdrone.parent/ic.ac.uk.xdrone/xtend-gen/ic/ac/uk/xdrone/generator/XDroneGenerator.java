...
public class XDroneGenerator extends AbstractGenerator {
  ...
  public CharSequence compileJS(final Fly fly) {
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("changeDroneCollisionBox(0.6,0,0.6)");
    _builder.newLine();
    _builder.append("\t\t\t");
  ...
  public CharSequence compilePython(final Main main) {
    ...
    _builder.newLine();
    _builder.append("DISTANCE_ONE_AND_HALF_SECOND = 85");
    _builder.newLine();
    _builder.append("DISTANCE_TWO_SECONDS = 120");
    _builder.newLine();
    _builder.append("DISTANCE_TWO_AND_HALF_SECONDS = 165");
    _builder.newLine();
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("if position[\'x\'] && position[\'z\']:");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t    ");
    _builder.append("ifangleToObject > 180:");
    _builder.newLine();
    _builder.append("\t      ");
    _builder.append("angleToObject = 360 - angleToObject;");
    _builder.newLine();
    _builder.append("\t      ");
    _builder.append("isPositive = !isPositive;");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t    ");
    _builder.append("return (isPositive ? angleToObject : -angleToObject)");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("else:");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("def moveBaseOnTime(distane, x ,y):");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("vel_msg.linear.x=x");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("vel_msg.linear.y=y  #y+ is left");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("vel_msg.linear.z=0");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("  \t");
    _builder.append("timeRequired = getTimeFromDistance(distane)");
    _builder.newLine();
    _builder.append("  ");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    {
      ...
      for(final String to : _takeoff) {
        ...
        _builder.newLine();
        _builder.append("moveBaseOnTime(5, 0, 0)");
        _builder.newLine();
      }
    }
    _builder.newLine();
  ...
  public CharSequence compile(final Command cmd) {
    ...
    }
    {
      if ((cmd instanceof Move)) {
        ...
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("moveBaseOnTime(1, 0, 0)");
        _builder.newLine();
        _builder.append("if ");
        String _x = ((Move)cmd).getVector().getX();
        _builder.append(_x);
