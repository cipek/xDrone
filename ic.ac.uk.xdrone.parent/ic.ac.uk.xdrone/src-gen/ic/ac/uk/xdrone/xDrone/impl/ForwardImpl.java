 ...
 * </p>
 * <ul>
 *   <li>{@link ic.ac.uk.xdrone.xDrone.impl.ForwardImpl#getDistance <em>Distance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ForwardImpl extends CommandImpl implements Forward
{
  ...
  {
    return XDronePackage.Literals.FORWARD;
  }
  ...
  public void setDistance(String newDistance)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XDronePackage.FORWARD__DISTANCE, oldDistance, distance));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XDronePackage.FORWARD__DISTANCE:
        return getDistance();
    }
